.PHONY: help sync install init-db import-users bootstrap-key run rundev check clean config-list config-set config-import config-export docker-up docker-down
